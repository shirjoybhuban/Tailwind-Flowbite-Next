...
import { HiCog, HiLogout, HiOutlineArrowRight, HiOutlineExclamationCircle } from 'react-icons/hi';
...
export default function Home() {
  return (
    <div className="p-4">
      ...
      <div className="mt-4 mb-5">
        <Tooltip content="Some couriers, such as Purolator, require a valid local phone number in order to process the quote and provide a rate. 1-800 numbers are not accepted."  style="light" className='border-2 border-secondary-900 bg-secondary-50 md:w-1/5  ' arrow={false}>
